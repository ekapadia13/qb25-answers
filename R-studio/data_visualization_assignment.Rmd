...
#Looking at the histogram distribution, they are very right-skewed, with most of the genes in the liver have very low TPMs, at zero or close to zero. Every cell in our body (except germ cells) have the same genome, however, all cells don't express all genes. There are only some genes which are expressed at high levels, these being the genes specifically related for those tissues. This is common to other tissues, which I can see by looking at Brain-Hippocampus.
